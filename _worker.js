...
// 设置优选地址api接口
let addressesapi = [
	'https://wb.668668.us.kg/w2Seven7/ipyx/main/yxip.txt?token=dykk', 
];
...
let subconverter = "dyzh.668668.us.kg"; //在线订阅转换后端，目前使用肥羊的订阅转换功能。支持自建psub 可自行搭建https://github.com/bulianglin/psub
